...
const superuser_guard_1 = require("../auth/superuser.guard");
let NotificationSettingsController = class NotificationSettingsController {
    notificationSettingsService;
    constructor(notificationSettingsService) {
...
exports.NotificationSettingsController = NotificationSettingsController = __decorate([
    ...
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, superuser_guard_1.SuperuserGuard),
